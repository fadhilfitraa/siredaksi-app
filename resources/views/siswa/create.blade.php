...
<head>
    ...
    <title>Tambah Siswa - SIREDAKSI</title>
...
<body>
    ...
    <div class="container mt-4 mb-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold text-dark mb-1">Tambah Siswa Baru</h4>
                <p class="text-muted small mb-0">Isi formulir di bawah untuk mendaftarkan siswa.</p>
            </div>
            ...
            <div class="col-lg-8">
                <div class="card card-custom">
                    ...
                    <div class="card-header bg-white p-4 border-bottom">
                        <h6 class="mb-0 fw-bold text-primary"><i class="fas fa-user-edit me-2"></i>Formulir Pendaftaran</h6>
                    </div>
                        ...
                        <form action="{{ route('siswa.store') }}" method="POST">
                            ...
                            <div class="row g-4 mb-4">
                                <div class="col-md-7">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama" class="form-control border @error('nama') is-invalid @enderror" placeholder="Contoh: Ibrahim Ahmad" value="{{ old('nama') }}" required>
                                    </div>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="no_hp" class="form-control border @error('no_hp') is-invalid @enderror" placeholder="08xxxxxxxxxx" value="{{ old('no_hp') }}">
                                    </div>
                            ...
                            <div class="row g-4 mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="kelas" class="form-control border @error('kelas') is-invalid @enderror" placeholder="Contoh: B1/5A/12.2" value="{{ old('kelas') }}" required>
                                    </div>
                            ...
                            <div class="mb-5">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="asal_sekolah" class="form-control border @error('asal_sekolah') is-invalid @enderror" placeholder="Contoh: SMA Al Kautsar" value="{{ old('asal_sekolah') }}">
                                </div>
                                <div class="form-text text-muted small ms-1">Kosongkan jika belum bersekolah.</div>
                            </div>
